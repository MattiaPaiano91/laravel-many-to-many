                            ...
                            @foreach ($technologies as $technology)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form class="d-inline-block" action="{{ route('admin.technologies.destroy', ['technology' => $technology->id]) }}" method="post" onsubmit="return confirm('Sei sicuro di voler eliminare questo technology?');">
                                            @csrf
                                            @method('DELETE')
